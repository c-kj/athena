...
# ATHENA_CMD="$ATHENA_CMD -r \"./output/Bondi+SN.final.rst\""   #TEMP 从某个 rst 文件开始继续模拟
# ATHENA_CMD="athena -d output -r \"Bondi+SN.00001.rst\" time/tlim=40"   #TEMP 从某个 rst 文件开始继续模拟
# ATHENA_CMD="athena -r \"./output/Bondi+SN.final.rst\" time/tlim=40"   #TEMP 从某个 rst 文件开始继续模拟
